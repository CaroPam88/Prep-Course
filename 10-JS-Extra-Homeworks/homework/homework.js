...
function asAmirror(str) {
  ...
  var palabraSeparada = str.split(" ")
    ...
    palabraInvertida.push(palabraSeparada[i].split("").reverse().join(""));
    }
...
function capicua(numero){
  ...
  var numeroreves= numeroString.split("").reverse().join("");
  if (numeroString === numeroreves){
    return "Es capicua";
  } else {
